Ext.define('ShoppingCart.view.main.MainController', {
    ...
    requires : [
        ...
        'ShoppingCart.view.products.detail.Main',
        'ShoppingCart.view.products.detail.View',
        'ShoppingCart.view.products.detail.ImageMain',
        'ShoppingCart.view.cart.List',
        'ShoppingCart.view.cart.PaymentForm',
        'ShoppingCart.view.cart.ExistingCarts',
    ...
    init : function () {
        ...
        // cnx update
        ShoppingCart.getApplication().on('beforelogout',me.resetCart);
    ...
    getOptions : function (callback, scope) {
        ...
        Ext.Ajax.request({
            ...
            success : function (response, opts) {
                ...
                if (!Ext.isEmpty(obj.Payms)) {
                    vm.getStore('cartPaymentOpts').loadRawData(obj.Payms);
                }
                if (!Ext.isEmpty(obj.Delms)) {
                    vm.getStore('cartDeliveryOpts').loadRawData(obj.Delms);
                }
                if (!Ext.isEmpty(obj.StockLoc)) {
                    vm.getStore('stockLocations').loadRawData(obj.StockLoc);
                }
                ...
                cmp = Ext.create('ShoppingCart.view.cart.Main', {
        ...
        Ext.Ajax.request({
            ...
            success : function (r) {
                ...
                if (d.success) {
                    ...
                    //
                    delvStr = vm.getStore('cartDeliveryOpts');
                    ...
                    Ext.Ajax.request({
                        ...
                        success : function (r) {
                            ...
                            if (d2.success) {
                                ...
                                ShoppingCart.util.Helper.printCart({
                                    data : data
                                });
                            } else {
                                me.showError(d2);
