Ext.define('Valence.common.field.AddressLookup', {
    ...
    config : {
         ...
         */
        gmapKey          : 'AIzaSyDlxwBeotnXkEG2ofte9A8qBHpwe3buJb4' //todo get new key for WFLA
    },
    ...
    initialize : function () {
        ...
        if (!me.isGoogleAvaliable() && Ext.isEmpty(me.getGmapKey())) {
            ...
            //
            me.setReadOnly(true);
            me.setPlaceHolder('Not available');
        ...
        if (setupLookup) {
            me.on({
                scope       : me,
                painted : me.onAfterRenderLookup
            });
        }
    },
